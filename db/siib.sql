...
--
-- Host: localhost:3306
-- Generation Time: Apr 03, 2024 at 06:49 AM
...
(12121221, '2024-04-03', '1111', 'ACER LAPTOP', 92, 1, 'pegawai', 0),
...
INSERT INTO `tb_barang` (`id`, `kode_brg`, `nama_brg`, `stok`, `rak`, `supplier`) VALUES
(1, '1111', 'ACER LAPTOP', 91, 'RAK 002\r\n', 'PT budi beriman sangat'),
(10, 'A011', 'KERTAS A4', 100, 'RAK 003', 'CV Indah Pertiwi');
...
CREATE TABLE `tb_barang_in` (
  ...
  `noinv` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8_general_ci NOT NULL,
  `supplier` varchar(255) NOT NULL,
  `kode_brg` varchar(11) NOT NULL,
  `nama_brg` varchar(255) NOT NULL,
  `stok` int NOT NULL,
...
--
ALTER TABLE `tb_barang_in`
  MODIFY `id_brg_in` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `tb_rak`
  MODIFY `id_rak` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `tb_sup`
--
ALTER TABLE `tb_sup`
  MODIFY `id_sup` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
COMMIT;
