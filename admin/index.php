...
switch($modul){
    ...
    case 'supplier': $aktif="Supplier"; $judul="Modul UAKPB "; include "modul/supplier/index.php"; break;
    case 'rak': $aktif="Rak"; $judul="Modul TIM "; include "modul/rak/index.php"; break;
