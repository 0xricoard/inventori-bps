        ...
        <form action="?m=supplier&s=update" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputEmail1" name="nama_sup"
              value="<?php echo $r['nama_sup']; ?>" aria-describedby="emailHelp" placeholder="Masukkan Nama UAKPB">
            <small id="emailHelp" class="form-text text-muted">Masukkan Nama</small>
          </div>
          <div class="form-group">
            <label>Kontak UAKPB</label>
            <input type="text" class="form-control" id="exampleInputEmail1" name="kontak_sup"
              aria-describedby="emailHelp" placeholder="Masukkan Kontak" value="<?php echo $r['kontak_sup']; ?>">
            <small class="form-text text-muted">Kontak UAKPB</small>
          </div>
          <div class="form-group">
            <label>Alamat UAKPB</label>
