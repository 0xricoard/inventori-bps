      ...
      <ul class="nav navbar-top-links navbar-right">
        <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="#">
            <img src="../images/admin/<?php echo $r['foto']; ?>" height="50"></i>
            <?php echo $r['nama']; ?>
          </a>
      ...
      <div class="row">
         <center>
           <form action="" method="POST">
             ...
             <input type="text" name="cari"> <button type="submit" name="go" class="btn btn-success">Cari Petugas</button>
           </form>
         </center>
       </div>
      <div class="row">
          ...
          <center>
            <ul class="pagination justify-content-center">
              ...
              for ($x = 1; $x <= $total_halaman; $x++) {
                ?>
                <li class="page-item"><a class="page-link" href="?m=petugas&s=awal&halaman=<?php echo $x ?>">
                    <?php echo $x; ?>
                  </a></li>
                <?php
              }
