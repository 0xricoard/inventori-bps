             ...
             <div class="modal-body">
               <form action="?m=barang&s=simpan" method="POST" enctype="multipart/form-data">
                 <div class="form-group">
                   ...
                   <input type="text" class="form-control" id="exampleInputEmail1" name="kode_brg" maxlength="20" aria-describedby="emailHelp" placeholder="Masukkan Kode Barang">
                 ...
                 <div class="form-group">
                   ...
                   <input type="text" class="form-control" id="exampleInputEmail1" name="satuan" aria-describedby="emailHelp" placeholder="Masukkan Satuan">
